...
\begin{remark}
When introduced in~\cite[Def.~xxx]{ecai06}, localisation was equivalently stated as 
...
\begin{lemma}
Let $A \in \mathcal{E}$ and $x \not \in fv(A)$. Then $A[^y/_x] = A$.\todo{Già dimostrato}
\end{lemma}
...
\def\oodiv{\; {\ominus\hspace{-7pt} \div} \;}
...
\begin{table}  %\hfil5
  ...
  \langle B, \sigma_1 \rangle \text{ with } \sigma_0 = \sigma \oodiv (\exists_x \pi)_\otimes }
  {\displaystyle \langle \exists^\pi_x A, \sigma \rangle \xrightarrow{\alpha}
  \langle \exists^{\pi \rho}_x B, \alpha \otimes \sigma \otimes \exists_x \rho \rangle  \text{ with } \rho = \sigma_1 \oodiv (\alpha \otimes \pi_\otimes  \otimes \sigma_0)}
...
These results ensure that a configuration is reachable if and only if it is l-reachable.
\\
...
The result is immediate for axioms ${\bf A1}$ and ${\bf A3}$, with 
...
by Lemma~\ref{mono2}.
%
Let us assume to have the reduction
...
$$\langle A, \pi_\otimes \otimes \tau_0 \rangle  \xrightarrow{\beta}
  \langle B, \tau_1 \rangle \text{ with } \tau_0 = \tau \odiv  (\exists_x \pi)_\otimes$$  for $\beta$ such that 
  $(\pi_\otimes \otimes \sigma_0) \odiv (\pi_\otimes \otimes \tau_0) \leq \beta$
  and $\sigma_1 = \tau_1 \otimes ((\pi_\otimes \otimes \sigma_0) \odiv (\pi_\otimes \otimes \tau_0 \otimes \beta))$,
  from which we can derive (if $x \not \in \beta$)
  $${\displaystyle\langle \exists^{\pi}_x A,\tau\rangle \xrightarrow{\beta} 
   \langle \exists^{\pi \xi}_x B, \beta \otimes  \tau \otimes \exists_x \xi
    \rangle \text{ with } \xi = \tau_1 \odiv (\beta \otimes \pi_\otimes \otimes \tau _0)}$$
and we just need to prove that $\sigma \odiv \tau \leq \beta$ and $\xi = \rho$, 
since from these properties it follows that
 $\sigma_1 = \sigma \otimes \exists_x \rho = \beta \otimes \tau \otimes \exists_x \xi \otimes (\sigma \odiv (\tau \otimes \beta))) = 
 \tau_1 \otimes (\sigma \odiv (\tau \otimes \beta))$.
...
%
%\noindent
As for the first property, $(\bigotimes \pi \otimes \sigma_0) \odiv (\bigotimes \pi \otimes \tau_0) \leq \beta$ implies 
by invertibility and Lemma~\ref{mono2} mentioned above that
$((\bigotimes \pi \odiv (\exists_x \pi)_\otimes) \otimes \sigma) \odiv (\bigotimes \pi \odiv (\exists_x \pi)_\otimes) \otimes \tau) \leq \beta$,
and then it follows that $\sigma \odiv \tau \leq \beta$
since $a \leq b$ implies $a \odiv b \leq (a \otimes c) \odiv (b \otimes c)$.
%since $a \odiv b \leq (a \otimes c) \odiv (b \otimes c)$ in all residuated POMs.

Now, recall that by monotonicity 
$\sigma_1 = (\sigma_1 \odiv ( \pi_\otimes \otimes \sigma_0)) \otimes  \pi_\otimes \otimes \sigma_0$ (Lemma~\ref{mono}) and
$\tau_1 = (\tau_1 \odiv (\beta \otimes \pi_\otimes \otimes \tau_0)) \otimes \beta \otimes \pi_\otimes \otimes \tau_0$ 
(Lemma~\ref{l-mono}). 
...
Let us now move to consider the axioms at the basis of the reduction
$$\langle A, \pi_\otimes \otimes \sigma_0 \rangle \to  \langle B, \sigma_1 \rangle$$
If is it using \mbox{\bf A1}, that is \mbox{\bf L1} for the labelled reduction, we have that 
$\beta = \1$. 
%
We then have to show the equivalence of $\rho =  \sigma_1 \odiv (\pi_\otimes \otimes \sigma_0)$ and
$\xi = \tau_1 \odiv (\pi_\otimes \otimes \tau_0)$.
%
By induction hypothesis 
$\sigma_1 = \tau_1 \otimes ((\pi_\otimes \otimes \sigma_0) \odiv (\pi_\otimes \otimes \tau_0))$,

If is it using \mbox{\bf A2}, that is \mbox{\bf L2} for the labelled reduction,
since $\C$ is localised it is possible to show that 
$\sigma_1 \odiv ( \pi_\otimes \otimes \sigma_0) = \tau_1 \odiv (\beta \otimes \pi_\otimes \otimes \tau_0) = \1$,
...
$\langle A, \alpha \otimes  \sigma \otimes d \rangle  \xrightarrow{}\langle A', \sigma' \rangle$.
  ...
  where $\alpha \otimes d \leq \beta$ and YYYY.
  ...
  Now, by localisation $(\alpha \otimes d) \odiv \beta \leq 1$ 
  and by Lemma~\ref{minor}
  we have 
  %$(\alpha \otimes d) \odiv \beta) \otimes \beta \otimes \sigma = \alpha \otimes d \otimes \sigma$
  $\langle B, (((\alpha \otimes d) \odiv \beta) \otimes \beta \otimes \sigma \rangle 
  \xrightarrow{} \langle B', \sigma''' \rangle$
  with 
  $\sigma''' = \sigma'' \otimes ([((\alpha \otimes d) \odiv \beta) \otimes \beta \otimes \sigma] 
  \odiv (\beta \otimes \sigma))$
\end{proof}
