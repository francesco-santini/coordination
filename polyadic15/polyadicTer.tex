...
\begin{definition}[localised/invertible]
...
First of all, note that by Lemma~\ref{minor} $\langle A, \sigma \rangle$ is reachable. So, we proceed by
induction on the proof of the reduction $\langle A, \sigma \rangle \to \langle B, \sigma' \rangle$. 

The result is immediate for axiom ${\bf A3}$, with 
$\alpha = \monid$, as well as for 
${\bf R1}$.

Consider instead and ${\bf A1}$. Again, $\alpha = \1$,
and since we are localised $\sigma \odiv \tau \leq \1 \leq \alpha$.
Now, $\sigma' = c \otimes \sigma$ and $\tau' = c \otimes \tau$,
so that by invertibility $\sigma' = \tau' \otimes (\sigma \odiv (\tau \otimes \alpha))$.
...
$\xi = \tau_1 \odiv (\pi_0 \otimes \tau)$.
%
Since  $\C$ is strongly localised by Lemma~\ref{LA2}
we have that $\sigma_1 = c\otimes \pi_0 \otimes \sigma$ and $\tau_1 = c\otimes \otimes \pi_0 \otimes \tau$,
hence $\rho = \xi = c$, and we are done.
%
\comment{
