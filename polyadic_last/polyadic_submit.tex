...
Moreover, we plan to also describe weak bisimulations, which is the main reason why we introduced barbs in this paper. In weak semantics, reduction cannot be observed and all systems are equivalent, and barbs were introduced to address this kind of issues~\cite{sangiorgi}.
