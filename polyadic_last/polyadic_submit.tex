...
This paper is a continuation of \cite{festcatuscia} with a concurrent constraint language on top of it.
%and process-equivalence relations.  
We will report the proof of the most important results only, for the sake of space. The work is organised as  follows.
Section~\ref{sec:bg}  
